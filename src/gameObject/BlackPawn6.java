...
public class BlackPawn6 extends MovingObject {
	...
	public void update() {
		...
		if(Mouse.bp6 && Mouse.mousePressed) {
			...
			Cell.calcAllowedCells(originalPos, Constants.bp6Id, firstMove, gameState);
			...
			if(Mouse.lastPiece == Constants.bp6Id && Mouse.mouseRealesed) {
				...
				Vector2D originalPos = Mouse.originalPos;
				Cell.deAllowCells(originalPos, Constants.bp6Id, firstMove, gameState);
				if(valida && firstMove) {
