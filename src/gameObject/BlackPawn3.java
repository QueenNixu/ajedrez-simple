...
public class BlackPawn3 extends MovingObject {
	...
	public void update() {
		...
		if(Mouse.bp3 && Mouse.mousePressed) {
			...
			Cell.calcAllowedCells(originalPos, Constants.bp3Id, firstMove, gameState);
			...
			if(Mouse.lastPiece == Constants.bp3Id && Mouse.mouseRealesed) {
				...
				Vector2D originalPos = Mouse.originalPos;
				Cell.deAllowCells(originalPos, Constants.bp3Id, firstMove, gameState);
				if(valida && firstMove) {
