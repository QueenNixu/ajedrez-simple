...
public class BlackPawn5 extends MovingObject {
	...
	public void update() {
		...
		if(Mouse.bp5 && Mouse.mousePressed) {
			...
			Cell.calcAllowedCells(originalPos, Constants.bp5Id, firstMove, gameState);
			...
			if(Mouse.lastPiece == Constants.bp5Id && Mouse.mouseRealesed) {
				...
				Vector2D originalPos = Mouse.originalPos;
				Cell.deAllowCells(originalPos, Constants.bp5Id, firstMove, gameState);
				if(valida && firstMove) {
