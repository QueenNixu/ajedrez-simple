...
public void update() {
		...
		if(Mouse.bk && Mouse.mousePressed) {
			...
			if(Mouse.lastPiece == 16 && Mouse.mouseRealesed) {
				...
				if(newX >= 0 && newY >= 0 && !allyCell(newX, newY) && ObjectPosition.allowedCellsBool[newX][newY] ) {
					...
					ObjectPosition.posicionesDelTablero[newX][newY] = 16;
					posicion.setX(getFromCell(Mouse.mouseXOnApp));
					posicion.setY(getFromCell(Mouse.mouseYOnApp));
					ObjectPosition.piecePosition[16] = new Vector2D(newX*60, newY*60);
	...
	private void deallowCells(Vector2D originalPos) {
		...
		if(j-1 >= 0 && i-1 >= 0 && !allyCell(i-1,j-1, 16)) {
		...
		i = iAux;
		j = jAux;
		if(i+1 <= 7 && j-1 >= 0&& !allyCell(i+1,j-1, 16)) {
			System.out.println("PINTANDO: "+(i+1)+","+(j-1));
			ObjectPosition.allowedCellsBool[i+1][j-1] = false;
			i++;
			j--;
		...
		i = iAux;
		j = jAux;
		if(j+1 <= 7 && i+1 <= 7 && !allyCell(i+1,j+1, 16)) {
			System.out.println("PINTANDO: "+(i+1)+","+(j+1));
			ObjectPosition.allowedCellsBool[i+1][j+1] = false;
			j++;
			i++;
		...
		i = iAux;
		j = jAux;
		if(i-1 >= 0 && j+1 <= 7 && !allyCell(i-1,j+1, 16)) {
			System.out.println("PINTANDO: "+(i-1)+","+(j+1));
			ObjectPosition.allowedCellsBool[i-1][j+1] = false;
			i--;
			j++;
	...
	private void calcAllowedCells(Vector2D originalPos) {
		...
		if(j-1 >= 0 && i-1 >= 0 && !allyCell(i-1,j-1)) {
			System.out.println("PINTANDO: "+(i-1)+","+(j-1));
			ObjectPosition.allowedCellsBool[i-1][j - 1] = true;
		}
		if(i+1 <= 7 && j-1 >= 0&& !allyCell(i+1,j-1)) {
			System.out.println("PINTANDO: "+(i+1)+","+(j-1));
			ObjectPosition.allowedCellsBool[i+1][j-1] = true;
		}
		if(j+1 <= 7 && i+1 <= 7 && !allyCell(i+1,j+1)) {
			System.out.println("PINTANDO: "+(i+1)+","+(j+1));
			ObjectPosition.allowedCellsBool[i+1][j+1] = true;
		}
		if(i-1 >= 0 && j+1 <= 7 && !allyCell(i-1,j+1)) {
			System.out.println("PINTANDO: "+(i-1)+","+(j+1));
			ObjectPosition.allowedCellsBool[i-1][j+1] = true;
		}
...
private boolean allyCell(int i, int j, int exception) {
		...
		if(ObjectPosition.posicionesDelTablero[i][j] == 16 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 17 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 18 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 19 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 20 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 21 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 22 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 23 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 24 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 25 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 26 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 27 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 28 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 29 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 30 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
		if(ObjectPosition.posicionesDelTablero[i][j] == 31 && ObjectPosition.posicionesDelTablero[i][j] != exception) return true;
